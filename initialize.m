...
global port_num MX28_GOAL_POSITION PROTOCOL_VERSION MX28_ID
...
% Default setting
MX28_ID                   = [1 2 3 4];  % Dynamixel ID: 1 2 3 4 5 6
BAUDRATE                  = 57600;
...
for i = 1:4
    ...
    write4ByteTxRx(port_num, PROTOCOL_VERSION, MX28_ID(i), PROFILE_VELOCITY, typecast(int32(round(30)), 'uint32'));
...
write4ByteTxRx(port_num, PROTOCOL_VERSION, MX28_ID(1), PROFILE_VELOCITY, typecast(int32(round(100)), 'uint32'));
